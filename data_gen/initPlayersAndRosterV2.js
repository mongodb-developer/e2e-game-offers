...
async function insertPlayersInBulk(startPlayerId, endPlayerId, client) {
    ...
    const playerTemplate1 = {
        ...
        "stats": {
            ...
            "total_collection_power":   {"$integer":{"min":1, "max":3200000}},
            "mvp_wins":                 {"$integer":{"min":0, "max":250}},
            "total_game_time_days":     {"$integer":{"min":1, "max":1200}},
            "total_money_spent":        {"$integer":{"min":1, "max":200}}
        },
    ...
    const playerTemplate2 = {
        ...
        "stats": {
            "player_level":             {"$integer":{"min":1, "max":80}},
            "characters_unlocked":      {"$integer":{"min":1, "max":12}},
            "total_collection_power":   {"$integer":{"min":3200001, "max":6400000}},
            "mvp_wins":                 {"$integer":{"min":200, "max":450}},
            "total_game_time_days":     {"$integer":{"min":1, "max":1200}},
            "total_money_spent":        {"$integer":{"min":201, "max":600}}
        },
        "global_game_counters" : {
            "gold":     {"$integer":{"min":1}},
            "energy":   {"$integer":{"min":1}}
    ...
    const playerTemplate3 = {
        ...
        "stats": {
            "player_level":             {"$integer":{"min":1, "max":80}},
            "characters_unlocked":      {"$integer":{"min":1, "max":12}},
            "total_collection_power":   {"$integer":{"min":6400001, "max":15200000}},
            "mvp_wins":                 {"$integer":{"min":300, "max":550}},
            "total_game_time_days":     {"$integer":{"min":1, "max":1200}},
            "total_money_spent":        {"$integer":{"min":601, "max":4000}}
        },
        "global_game_counters" : {
            "gold":     {"$integer":{"min":1}},
            "energy":   {"$integer":{"min":1}}
    ...
    const playerTemplate4 = {
        ...
        "stats": {
            "player_level":             {"$integer":{"min":1, "max":80}},
            "characters_unlocked":      {"$integer":{"min":1, "max":12}},
            "total_collection_power":   {"$integer":{"min":15200001, "max":24000000}},
            "mvp_wins":                 {"$integer":{"min":500, "max":650}},
            "total_game_time_days":     {"$integer":{"min":1, "max":1200}},
            "total_money_spent":        {"$integer":{"min":4001, "max":10000}}
        },
        "global_game_counters" : {
            "gold":     {"$integer":{"min":1}},
            "energy":   {"$integer":{"min":1}}
    ...
    for (playerId = startPlayerId; playerId <= endPlayerId; playerId++) {
        let player = {};
        switch( playerType = Math.floor(Math.random()*11)){
            case 0:
            case 1:
            case 2:
                player = mgenerate(playerTemplate1);
            case 3:            
            case 4:
            case 5:
            case 6:
            case 7:
            case 8:
                player = mgenerate(playerTemplate2);
            case 9:
                player = mgenerate(playerTemplate3);
            default:
                player = mgenerate(playerTemplate4);
        }
...
//TODO Normalize the data so that the roaster is made according to the type of player
