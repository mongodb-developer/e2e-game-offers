...
*/  
  ...
  */
  ...
  // OLD MODEL TBL6662871139531882496
  const OLD_payloadForML = {
    "payload": {
      "row": {
        "values": [
  ...
  // NEW MODEL TBL3991779163664023552
  const payloadForML = {
    "payload": {
      "row": {
        "values": [
        ...
        "columnSpecIds": [
          ...
          "2196624670936006656",  // characterId (1 - 12)   Source: playerActivityForPersonalizedOffers
          ...
          "8177404976084025344",  // Character Grade A-C    Source: playerRoster[roser.charactedId = characterId]. "A" (1,5 & 9) "B" (2,6, & 10) "C" (3,7 & 11) "D" (4,8 & 12) 
...
async function callAutoML(payload) {
  ...
  return http.post({
      //url: "https://automl.googleapis.com/v1beta1/projects/e2e-game-offers/locations/us-central1/models/TBL6662871139531882496:predict",  //ORIGINAL MODEL
